...
Run =make magic -log_level=debug= to see the protocol in detail.
...
*Always great to sign your emails,*  /gets instant replies from me/ -- keys hosted [[https://blog.rtshkmr.com/keys/rtshkmr-public-key.asc][here]] or [[https://keys.openpgp.org/vks/v1/by-fingerprint/23BBA8476AA5F3FE0D944DD136F1C1A8EE1EB352][here]] :
#+begin_src sh
