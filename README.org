...
It works in Emacs preview, GitHub README.org, and HTML export.
#+END_CENTER
...
> It uses GitHub's Markdown alert styling when rendered.
#+END_EXPORT

#+BEGIN_EXPORT html
> [!WARNING]
> Danger! This is a **warning**.
> Supports bold, italic, lists, and code too.
#+END_EXPORT

#+BEGIN_EXPORT html
> [!TIP]
> Pro tip: Combine with Org headings for structure.
#+END_EXPORT
